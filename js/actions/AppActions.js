...
import { NEXT_VERSE, PREVIOUS_VERSE, ENABLE_RECALL, ENABLE_READ, CHANGE_MODE, ENABLE_LISTEN, PAUSE_AUDIO } from '../constants/AppConstants';
...
export function asyncEnableListen(index) {
  return (dispatch) => {
    // You can do async stuff here!
    // API fetching, Animations,...
    // For more information as to how and why you would do this, check https://github.com/gaearon/redux-thunk
    return dispatch(enableListen(index));
  }
}

export function enableListen(index) {
  return { type: ENABLE_LISTEN, index };
}
